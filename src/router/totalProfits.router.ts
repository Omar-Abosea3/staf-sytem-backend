...
import { addTotalProfits, getStafManTotalProfits, getAllTotalProfitsWithFilters } from '../controllers/totalProfits.controller.js';
...
totalProfitsRouter
    ...
    .get('/:id', isAuthenticated([systemRoles.ADMIN, systemRoles.STAF]), getStafManTotalProfits);
